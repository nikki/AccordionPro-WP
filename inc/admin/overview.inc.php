...
<table class="wp-list-table widefat users ap-overview" cellspacing="0">
    ...
    ?>
        	<tr id="accordion-<?php echo $post->ID; ?>">
                ...
                <td class="ap-icon"><a href="#" class="ap-clone-acc"><span class="dashicons dashicons-admin-page"></span></a></td>
                <td class="ap-icon"><a href="<?php echo wp_nonce_url($url, 'delete', 'accordion_pro'); ?>" class="ap-del-acc" data-confirm="<?php _e('Are you sure you want to delete ', 'accordion_pro'); echo $post->post_title; ?>?"><span class="dashicons dashicons-trash"></span></a></td>
    		</tr>
    <?php
        }
    ?>
